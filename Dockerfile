...
# -----------------------------------------
    ...
    # Ensure people index was generated by CI and included in the Docker build context
    RUN test -s public/people-index.json || (echo "ERROR: public/people-index.json missing (run 'pnpm run generate:people' in CI before docker build)" && exit 1)
