...
import ViewToggle from "@/app/(home)/components/ViewToggle";
  ...
  return (
    <div className="flex items-center justify-between flex-wrap gap-x-4 gap-y-2 m-4">
      <h1 className="m-0 flex items-end max-sm:flex-col max-sm:items-start">
        ...
        <span
          className="text-gray-600 text-base md:text-lg font-normal"
          data-tina-field={tinaField(homepage, "tagline")}
        >
          {tagline}
        </span>
      </h1>
