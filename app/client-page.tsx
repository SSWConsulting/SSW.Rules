...
export default function HomeClientPage(props: HomeClientPageProps) {
  const { topCategories, latestRules, ruleCount, categoryRuleCounts, quickLinks, activityRules, recentComments, initialView } = props;
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between flex-wrap gap-x-4 gap-y-2 m-4">
        ...
        <ViewToggle activeView={initialView} />
      </div>
