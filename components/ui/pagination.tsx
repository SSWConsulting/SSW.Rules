...
export default function Pagination({ currentPage, totalPages, totalItems, itemsPerPage, onPageChange, onItemsPerPageChange, className }: PaginationProps) {
          ...
          <div className="flex items-center gap-1">
            {visiblePages.map((page, index) => {
              if (page === "ellipsis-start" || page === "ellipsis-end") {
                return (
                  <div key={`ellipsis-${index}`} className="flex items-center justify-center w-8 h-8 text-gray-500">
                    <RiMoreFill />
                  </div>
                );
              }
              ...
              return (
                <Button
                  ...
                  className={cn("w-8 h-8 p-0 text-sm cursor-pointer", isActive && "bg-ssw-red text-white hover:bg-ssw-red/90")}
                >
                  {pageNum}
                </Button>
              );
