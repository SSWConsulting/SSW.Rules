      ...
      <Popover>
        {({ open }) => (
          <>
            ...
            <div className="absolute left-0 -bottom-2 translate-y-full z-1000 min-w-[600px] max-w-[800px]">
              <Transition
              ...
              >
                <PopoverPanel className="relative overflow-hidden rounded-lg shadow-lg bg-white border border-gray-150 z-50 w-full">
                  {({ close }) => (
